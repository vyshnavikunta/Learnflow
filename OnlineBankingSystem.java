...
public class OnlineBankingSystem {
    ...
    private static void viewAllAccounts() {
        if (accounts.isEmpty()) {
            ...
            System.out.println("Account Number\tUsername\tBalance\tPhone Number");
            for (Account account : accounts) {
                System.out.println(account.accountNumber + "\t\t" + account.username + "\t\t$" + account.balance + "\t\t" + account.phoneNumber);
            }
        }
    }
    ...
    private static void viewBalance() {
        if (loggedInAccount != null) {
            System.out.println("Your current balance: $" + loggedInAccount.balance);
        } else {
            System.out.println("No account logged in.");
        }
    }
